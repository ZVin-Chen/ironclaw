...
I18n.register('en', {
  ...
  'restart.currentVersion': 'Current version: v{version}',
  'restart.dataWarning': 'If your deployment uses a mutable image tag (e.g. "latest"), restarting may change the running version. A version downgrade can cause data loss. Pin your image to a specific version tag to avoid this.',
  'restart.versionChanged': 'Warning: IronClaw version changed after restart (was v{oldVersion}, now v{newVersion}). If this was not intentional, check your deployment configuration.',
